...
```{r}
de.genes <- read.table(gzfile('GSE106886_Rao-2017-CMVnotreat_vs_RAD21treat.Genes.DESeq2.txt.gz'))
# Add "symbol" column
...
```{r}
rad21 <- read.table('46207_chr1_peaks.bed')
